...
class ReportsController {
    list(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            database_1.default.query('select * from log_viaje', function (err, result, fields) {
                if (err)
                    throw err;
                res.json(result);
                console.log(result);
    ...
    getLogById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            database_1.default.query('select * from log_viaje where user_id = ?', [id], function (err, result, fields) {
                if (err)
                    throw err;
                res.json(result);
                console.log(result);
